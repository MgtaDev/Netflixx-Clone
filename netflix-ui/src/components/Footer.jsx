...
const Footer = () => {
  return (
    <div role="contentinfo" class="member-footer snipcss-DrssT" id="member-footer">
  <div class="social-links">
    <a class="social-link" href="https://www.facebook.com/Netflixmx" target="_blank" aria-label="facebook">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-icon svg-icon-facebook-logo ltr-4z3qvp e1svuwfo1" data-name="Facebook" aria-hidden="true">
    ...
    <a class="social-link" href="https://www.instagram.com/NetflixLAT" target="_blank" aria-label="instagram">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-icon svg-icon-instagram-logo ltr-4z3qvp e1svuwfo1" data-name="Instagram" aria-hidden="true">
    ...
    <a class="social-link" href="https://twitter.com/netflixLAT" target="_blank" aria-label="twitter">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-icon svg-icon-twitter-logo ltr-4z3qvp e1svuwfo1" data-name="Twitter" aria-hidden="true">
    ...
    <a class="social-link" href="https://www.youtube.com/channel/UC5ZiUaIJ2b5dYBYGf5iEUrA" target="_blank" aria-label="youtube">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-icon svg-icon-youtube-logo ltr-4z3qvp e1svuwfo1" data-name="Youtube" aria-hidden="true">
  ...
  <div class="member-footer-service space-beetween a-center">
    <button class="service-code">
      Código de servicio
    </button>
     <span className='member-footer-copyright'>
      © 1997-2023 Netflix.
    </span>
